    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          if (_context.t0.response.data.message.includes('password')) {
            (0, _alerts.showAlert)('error', 'Please provide a valid password');
          } else {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log(_session); // 2) Create checkout form + charge credit card
